...
# Configuration Script – CNE12 - Rev. A

This **Configuration** script is designed for the **CNE12** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – CNE12 Rev. A

Este script de **Configuration** está diseñado para el modelo **CNE12** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).

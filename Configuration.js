...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("3", "VALVE_STATUS", endpointType.appliance, applianceEndpointSubType.valve); 
    ...
    var valveStatusGenEndpoint = endpoints.addEndpoint("9", "VALVE_STATUS_GEN", endpointType.genericSensor);
    valveStatusGenEndpoint.variableTypeId = 10;

    //var openValveTimeEndpoint = endpoints.addEndpoint("10", "OPEN_VALVE_TIME_COUNTER", endpointType.genericSensor);
    //openValveTimeEndpoint.variableTypeId(667);
    ...
    //var shutInMinTurnerEndpoint = endpoints.addEndpoint("14", "SHUT_IN_MIN_TURNER", endpointType.genericSensor);
    //shutInMinTurnerEndpoint.variableTypeId(668);

    //var maintCyclesMinTurnerEndpoint = endpoints.addEndpoint("15", "MAINT_CYCLES_MIN_TURNER", endpointType.genericSensor);
    //maintCyclesMinTurnerEndpoint.variableTypeId(669);
    ...
    //var shutInOpeningModeEndpoint = endpoints.addEndpoint("22", "SHUT_IN_OPENING_MODE", endpointType.genericSensor);
    //shutInOpeningModeEndpoint.variableTypeId(670);
    
    //var shutInClosingModeEndpoint = endpoints.addEndpoint("23", "SHUT_IN_CLOSING_MODE", endpointType.genericSensor);
    //shutInClosingModeEndpoint.variableTypeId(671);
